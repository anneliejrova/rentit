---
name: Technical Task (SPA)
about: Template for technical tasks and structural scaffolding.
title: "TECH: "
...
- [ ] JS Function Comments (in code): Every JS function is documented with a description of its purpose, parameters, and return value.
