export function renderAbout() {
  return /*html*/`
  <div class="pt-15 bg-olive-200">
    <div class="flex flex-col max-w-1/2 mx-auto gap-6">
      <h2 class="text-3xl md:text-4xl font-bold font-serif">Om oss</h2>
      <p class="text-2xl">
        <p class="text-xl">Rentit – Varför äga när du kan göra?</p>
        <p class="text-xl">Tro på projektet, inte på prylarna!</p>
