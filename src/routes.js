export const routes = [
  ...
  { slug: "checkout",     title: "Bokning",      headertxt: "Checkout",                                       component: () => import('./views/checkout.js') },
  { slug: "confirmation", title: "Bekräftelse",  headertxt: "Tack!",                                          component: () => import('./views/confirmation.js') }
];
